...
- [ ] **Status:** IN_REVIEW — código em [migracao/backend/internal/platform/{tenancy,database}](../../migracao/backend/internal/platform/); histórico em [execucoes/GO-007.md](execucoes/GO-007.md)
