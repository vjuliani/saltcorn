...
Para desenvolver e visualizar a migração no computador, siga o [how-to de execução local de frontend, BFF e backend](EXECUCAO-LOCAL.md). Para executar toda a aplicação em containers, use o [passo a passo de Docker Compose](DOCKER-COMPOSE.md).
